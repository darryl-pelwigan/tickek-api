...
Route::middleware('auth:sanctum')->group(function() {
    ...
    Route::put('authors/{authors}/tickets/{ticket}', [AuthorTicketsController::class, 'replace']);
    Route::patch('authors/{authors}/tickets/{ticket}', [AuthorTicketsController::class, 'update']);
});
